...
module.exports. run = function({ api, event, args, getText }) {
    ...
    const text = `{page (${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}) help 1 help 2}\n𝐎𝐖𝐍𝐄𝐑: 𒄬𓆩๛⃝ JOY AHMED‣᭄𓆪)<♻️🌹\n𝐀𝐍𝐘 𝐇𝐄𝐋𝐏 𝐀𝐍𝐃 𝐀𝐍𝐘 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐘 𝐁𝐎𝐒𝐒:\n🌹♻️𝐌𝐘 𝐁𝐎𝐒𝐒: 𒄬𓆩๛⃝ JOY AHMED‣᭄𓆪🌹♻️❤️\n𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃: https://www.facebook.com/profile.php?id=100000121528628🌹♻️ THANKS FOR USING MY BOT♻️🌹`;  
